...
module.exports = Object.freeze({
  ...
  // User Link Open Request (ULinkOR)
  WB_ULINKOR_ASK: 'WB_ULINKOR_ASK',
  WB_ULINKOR_OPEN: 'WB_ULINKOR_OPEN',
  WB_ULINKOR_CANCEL: 'WB_ULINKOR_CANCEL',
  ...
  WB_TRAY_TOGGLE_ALWAYS_ON_TOP: 'WB_TRAY_TOGGLE_ALWAYS_ON_TOP',
  WB_TRAY_WINDOWED_MODE_CHANGED: 'WB_TRAY_WINDOWED_MODE_CHANGED',
  WB_TRAY_WINDOWED_ALWAYS_ON_TOP_CHANGED: 'WB_TRAY_WINDOWED_ALWAYS_ON_TOP_CHANGED',
  WB_TOGGLE_TRAY_WITH_BOUNDS: 'WB_TOGGLE_TRAY_WITH_BOUNDS',
  WB_TRAY_ICON_CREATED: 'WB_TRAY_ICON_CREATED',
  WB_TRAY_ICON_DESTROYED: 'WB_TRAY_ICON_DESTROYED',
  ...
  WB_WINDOW_MIN_MAX_DBL_CLICK: 'WB_WINDOW_MIN_MAX_DBL_CLICK',
  WB_WINDOW_RESET_VISUAL_ZOOM: 'WB_WINDOW_RESET_VISUAL_ZOOM',
  ...
  WB_MAILBOXES_WINDOW_NAVIGATE_AND_SWITCH_TO_SERVICE: 'WB_MAILBOXES_WINDOW_NAVIGATE_AND_SWITCH_TO_SERVICE',
  WB_MAILBOXES_WINDOW_RUN_COMMAND_AND_SWITCH_TO_SERVICE: 'WB_MAILBOXES_WINDOW_RUN_COMMAND_AND_SWITCH_TO_SERVICE',
  WB_MAILBOXES_WINDOW_OPEN_COMMAND_PALETTE: 'WB_MAILBOXES_WINDOW_OPEN_COMMAND_PALETTE',

  // Quick switch
  WB_QUICK_SWITCH_NEXT: 'WB_QUICK_SWITCH_NEXT',
  WB_QUICK_SWITCH_PREV: 'WB_QUICK_SWITCH_PREV',
  WB_QUICK_SWITCH_PRESENT_NEXT: 'WB_QUICK_SWITCH_PRESENT_NEXT',
  WB_QUICK_SWITCH_PRESENT_PREV: 'WB_QUICK_SWITCH_PRESENT_PREV',
  WB_QUICK_SWITCH_HIGHLIGHT_NEXT: 'WB_QUICK_SWITCH_HIGHLIGHT_NEXT',
  WB_QUICK_SWITCH_HIGHLIGHT_PREV: 'WB_QUICK_SWITCH_HIGHLIGHT_PREV',
  WB_QUICK_SWITCH_SELECT: 'WB_QUICK_SWITCH_SELECT',
  ...
  WB_GUEST_API_SEND_COMMAND: 'WB_GUEST_API_SEND_COMMAND',
  WB_GUEST_API_OPEN_CONTAINER_FOLDER: 'WB_GUEST_API_OPEN_CONTAINER_FOLDER',

  // Reading Queue
  WB_READING_QUEUE_LINK_ADDED: 'WB_READING_QUEUE_LINK_ADDED',
  WB_READING_QUEUE_CURRENT_PAGE_ADDED: 'WB_READING_QUEUE_CURRENT_PAGE_ADDED',
  WB_READING_QUEUE_OPEN_URL: 'WB_READING_QUEUE_OPEN_URL',
  WB_READING_QUEUE_OPEN_URL_EMPTY: 'WB_READING_QUEUE_OPEN_URL_EMPTY',
  ...
  WB_METRICS_FETCH_CHROMIUM_METRICS: 'WB_METRICS_FETCH_CHROMIUM_METRICS',

  // Keychain
  WB_KEYCHAIN_OPEN: 'WB_KEYCHAIN_OPEN',

  // App lifecycle
  WB_FOCUS_APP: 'WB_FOCUS_APP',
  WB_QUIT_APP: 'WB_QUIT_APP',
  WB_RELAUNCH_APP: 'WB_RELAUNCH_APP',
  WB_ATTEMPT_FULL_QUIT_KEYBOARD_ACCEL: 'WB_ATTEMPT_FULL_QUIT_KEYBOARD_ACCEL',

  // Data management
  WB_CLEAN_EXPIRED_SESSIONS: 'WB_CLEAN_EXPIRED_SESSIONS',
  WB_OPEN_CERTIFICATES_FOLDER: 'WB_OPEN_CERTIFICATES_FOLDER',
  ...
  WB_WCFETCH_SERVICE_TEXT: 'WB_WCFETCH_SERVICE_TEXT',
  WB_WCFETCH_SERVICE_TEXT_CLEANUP: 'WB_WCFETCH_SERVICE_TEXT_CLEANUP',

  // Power Monitor
  WB_GET_POWER_MONITOR_STATE_SYNC: 'WB_GET_POWER_MONITOR_STATE_SYNC',
  WB_POWER_MONITOR_CONNECT_EVENTS: 'WB_POWER_MONITOR_CONNECT_EVENTS',
  WB_POWER_MONITOR_DISCONNECT_EVENTS: 'WB_POWER_MONITOR_DISCONNECT_EVENTS',
  WB_POWER_MONITOR_EVENT: 'WB_POWER_MONITOR_EVENT',
  WB_POWER_MONITOR_QUERY_IDLE_TIME: 'WB_POWER_MONITOR_QUERY_IDLE_TIME',

  // Downlodas
  WB_DOWNLOAD_CANCEL_RUNNING: 'WB_DOWNLOAD_CANCEL_RUNNING',

  // IEngine
  WB_IENGINE_AUTH_SERVICE: 'WB_IENGINE_AUTH_SERVICE',
  WB_IENGINE_RELOAD_FOREGROUND_: 'WB_IENGINE_RELOAD_FOREGROUND_',
  WB_IENGINE_MESSAGE_FOREGROUND_: 'WB_IENGINE_MESSAGE_FOREGROUND_',
  WB_IENGINE_MESSAGE_BACKGROUND_: 'WB_IENGINE_MESSAGE_BACKGROUND_',
  WB_IENGINE_OPEN_ITEM_: 'WB_IENGINE_OPEN_ITEM_',
  WB_IENGINE_COMPOSE_ITEM_: 'WB_IENGINE_COMPOSE_ITEM_',
  WB_IENGINE_LOG_NETWORK_EVENTS_: 'WB_IENGINE_LOG_NETWORK_EVENTS_'
})
