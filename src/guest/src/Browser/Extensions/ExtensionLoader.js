...
const DEQUEUE_ENDPOINTS = new Set([
  ...
  */
  ...
  WAVEBOX_CONTENT_IMPL_ENDPOINTS.GOOGLE_MAIL_HTTP_WATCHER,
  WAVEBOX_CONTENT_IMPL_ENDPOINTS.GOOGLE_CHAT_WINDOW_OPEN,
  WAVEBOX_CONTENT_IMPL_ENDPOINTS.FASTMAIL_WINDOW_OPEN,
  WAVEBOX_CONTENT_IMPL_ENDPOINTS.SKYPE_WINDOW_OPEN
])
