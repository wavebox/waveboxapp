import WaveboxContentImplProvider from './WaveboxContentImplProvider'
import UserExtensionProvider from './UserExtensionProvider'
...
export default new ContentExtensionProvider()
