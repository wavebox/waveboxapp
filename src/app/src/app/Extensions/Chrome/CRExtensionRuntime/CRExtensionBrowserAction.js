...
const CRExtensionUISubscriber = require('../CRExtensionUISubscriber')
const {
...
} = require('../../../../shared/Models/CRExtensionRT')
...
class CRExtensionBrowserAction {
  ...
  constructor (extension) {
    ClassTools.autobindFunctions(this, [
      ...
      'handleFetchPopup',
      'handleSetBadgeText',
      'handleFetchBadgeText',
      'handleSetBadgeBackgroundColor',
      'handleFetchBadgeBackgroundColor',
      'handleEnable',
      'handleDisable',
      'handleClick'
    ])
...
module.exports = CRExtensionBrowserAction
