...
const CRExtensionRuntime = require('./CRExtensionRuntime')
...
class CRExtensionRuntimeHandler {
  ...
  constructor () {
    ...
    ClassTools.autobindFunctions(this, [
      '_handleRuntimeSendmessage',
      '_handleTabsSendmessage',
      '_handleChromeExtensionBufferRequest',
      '_handleGetRuntimeData',
      '_handleGetRuntimeContextMenuData',
      '_handleOpenOptionsPage',
      '_handleInspectBackground'
    ])
