const WINDOW_OPEN_MODES = Object.freeze({
  CONTENT: 'CONTENT',
  CONTENT_PROVSIONAL: 'CONTENT_PROVSIONAL', // typo. Found in 4.3.1beta. Update wire config and remove after 4.5.0 release
  CONTENT_PROVISIONAL: 'CONTENT_PROVISIONAL',
  POPUP_CONTENT: 'POPUP_CONTENT',
  EXTERNAL: 'EXTERNAL',
  EXTERNAL_PROVSIONAL: 'EXTERNAL_PROVSIONAL', // typo. Found in 4.3.1beta. Update wire config and remove after 4.5.0 release
