...
module.exports = function (env) {
  ...
  return {
    ...
    plugins: [
      ...
      // Dev tools
      process.env.NOTIFICATIONS === 'true' ? new WebpackNotifierPlugin({ title: 'WB Print', alwaysNotify: true }) : undefined,
      new WebpackOnBuildPlugin((stats) => { console.log('WB Print') })
    ].filter((p) => !!p),
    resolve: {
