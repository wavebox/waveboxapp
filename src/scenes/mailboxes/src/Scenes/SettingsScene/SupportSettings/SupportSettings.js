...
import { Button, Paper, Icon } from 'material-ui'
...
export default class SupportSettings extends React.Component {
  ...
  * @return jsx
  */
  renderBoxedCell (classes, iconName, title, text, buttonLabel, click) {
    return (
      <Paper className={classes.boxedCell}>
        <div className={classes.imageContainer}>
          <Icon className={classNames(iconName, classes.iconBoxed)} />
        </div>
        <div className={classes.contentContainer}>
