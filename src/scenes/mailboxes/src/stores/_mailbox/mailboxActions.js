...
class MailboxActions extends RendererMailboxActions {
  ...
  */
  setWebcontentTabId (mailboxId, serviceType, tabId) { //TODO
  ...
  * @param serviceType: the type of service
  */
  deleteWebcontentTabId (mailboxId, serviceType) { //TODO
  ...
  */
  /*connectAllMailboxes () { //TODO depricated
    return {}
  }*/
  ...
  * @param mailboxId: the id of the mailbox
  */
  /*connectMailbox (mailboxId) { //TODO depricated
  ...
  */
  /*disconnectAllMailboxes () { //TODO depricated
    return {}
  }*/
  ...
  * @param mailboxId: the id of the mailbox
  */
  /*disconnectMailbox (mailboxId) { //TODO depricated
    return { mailboxId: mailboxId }
  }*/
