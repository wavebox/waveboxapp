...
module.exports = function (env) {
  ...
  return {
    ...
    plugins: [
      ...
      process.env.NOTIFICATIONS === 'true' ? new WebpackNotifierPlugin({ title: 'WB Keychain', alwaysNotify: true }) : undefined,
      new WebpackOnBuildPlugin((stats) => { console.log('WB Keychain') })
    ].filter((p) => !!p),
    resolve: {
