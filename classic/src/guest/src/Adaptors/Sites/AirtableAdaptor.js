...
class AirtableAdaptor extends BaseAdaptor {
  /* **************************************************************************/
  // Class properties
  /* **************************************************************************/
  ...
  executeJS () {
    this[privPdfObserver] = new window.MutationObserver((mutations) => {
      const frames = document.body.querySelectorAll('iframe[src*=".pdf"]:not(.wavebox-pdf-iframe-preview-enabled)')
...
export default AirtableAdaptor
